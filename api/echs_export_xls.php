...
$cols = ['Claim ID','Region','Hospital','Card ID','Name of ESM','Patient','Doctor','Type','Admit','Accept Date',
...
while ($r = $st->fetch()) {
    ...
    echo '<td>="'.x($r['card_id']).'"</td><td>'.x($r['esm_name']).'</td><td>'.x($r['patient_name']).'</td><td>'.x($r['doctor_name']).'</td>';
