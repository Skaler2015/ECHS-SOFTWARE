...
$st = db()->prepare("SELECT claim_id,region,hospital_name,card_id,esm_name,patient_name,doctor_name,patient_type,admit_type,
...
fputcsv($out, ['Claim ID','Region','Hospital','Card ID','Name of ESM','Patient','Doctor','Type','Admit','Accept Date',
...
while ($r = $st->fetch()) {
    fputcsv($out, [$r['claim_id'],$r['region'],$r['hospital_name'],$r['card_id'],$r['esm_name'],$r['patient_name'],
        $r['doctor_name'],$r['patient_type'],$r['admit_type'],$r['accept_date_raw'],$r['net_claim_amt'],$r['approved_amt'],$r['deduction'],
